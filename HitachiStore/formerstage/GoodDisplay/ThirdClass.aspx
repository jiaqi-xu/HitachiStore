<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ThirdClass.aspx.cs" Inherits="HitachiStore.formerstage.GoodDisplay.ThirdClass"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 20%; float: left; height: 1000px; background-image: url(../../image/左侧树背景2.png);">
        <asp:DataList ID="DataList1" runat="server" Width="100%" RepeatColumns="2" DataKeyField="SecondClassDmName">
            ...
            <ItemTemplate>
                <div>
                    <asp:LinkButton ID="lbtn_SecondClass" runat="server" CommandName="Delete"><%#Eval("ThirdClassDmName")%></asp:LinkButton>
                </div>
            </ItemTemplate>
        </asp:DataList>
    </div>
              ...
              <ItemTemplate>
                 <table>
                    <tr>
                       ...
                       <td><%#Eval("PropertyContentName") %></td>
                    </tr>
                 </table>
              </ItemTemplate>
           </asp:DataList>--%>
            ...
            <ItemTemplate>
                ...
                <div style="height: 70px; width: 100%; border: 1px solid red">
                    <div style="height: 40px">
                        <asp:Label ID="Label2" runat="server" Text='<%#Eval("ImgTitle") %>'></asp:Label>
                    </div>
