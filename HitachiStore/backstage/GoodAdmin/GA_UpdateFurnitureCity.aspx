<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GA_UpdateFurnitureCity.aspx.cs" Inherits="HitachiStore.backstage.GoodAdmin.GA_UpdateFurnitureCity" %>
            ...
            <ContentTemplate>
                ...
                <div style="float: right; width: 433px; height: 430px; background-color: Gray; margin-right: 10px;
                    ...
                    <asp:DataList runat="server" ID="dlistPictureShow" RepeatColumns="2" RepeatDirection="Horizontal"
                        OnEditCommand="dlistPictureShow_EditCommand" DataKeyField="ImgAddress">
                        <ItemTemplate>
                            <div style="width: 220; height: 64px">
                                <%-- <img src='<%#Eval("ImgAddress") %>' runat="server" style="width: 210px; height: 64px;
                                    margin-left: 5px" />--%>
