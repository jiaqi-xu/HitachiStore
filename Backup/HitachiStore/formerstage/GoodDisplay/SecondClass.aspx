<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecondClass.aspx.cs" Inherits="HitachiStore.formerstage.GoodDisplay.SecondClass"
...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div style="width: 20%; float: left; height: 1000px; background-image: url(../../image/左侧树背景2.png);">
        <asp:DataList ID="DataList1" runat="server" Width="100%" RepeatColumns="2" DataKeyField="ThirdClassDmName"
            ...
            <ItemTemplate>
                <div style="text-align: left; font-size: large; text-align: center">
                    <asp:LinkButton ID="lbtn_ThirdClass" runat="server" CommandName="Delete"><%#Eval("ThirdClassDmName")%></asp:LinkButton>
                </div>
            </ItemTemplate>
        </asp:DataList>
    </div>
