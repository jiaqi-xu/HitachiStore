<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FirstClass.aspx.cs" Inherits="HitachiStore.formerstage.GoodDisplay.FirstClass"
...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div style="width: 20%; float: left; height: 1000px; background-image: url(../../image/左侧树背景2.png);">
        <asp:DataList ID="DataList1" runat="server" Width="100%" RepeatColumns="2" DataKeyField="SecondClassDmName"
            OnDeleteCommand="DataList1_DeleteCommand">
            <HeaderTemplate>
                <table style="width: 100%;">
                    <tr>
                        <td>
                            <asp:Label ID="Label1" runat="server" Text='<%#this.Set()%>'></asp:Label>
                        </td>
                    </tr>
                    <tr>
            ...
            <ItemTemplate>
                <div>
                    <asp:LinkButton ID="lbtn_SecondClass" runat="server" CommandName="Delete"><%#Eval("SecondClassDmName")%></asp:LinkButton>
                </div>
            </ItemTemplate>
        </asp:DataList>
    </div>
    <div style="width: 80%; float: left;">
        <asp:DataList ID="datalist_good" runat="server" Width="100%" RepeatColumns="4" 
            RepeatDirection="Horizontal" ondeletecommand="datalist_good_DeleteCommand">
            <ItemTemplate>
                ...
                <div style="height: 70px; width: 100%; border: 1px solid red">
                    ...
                    <div style="float: right; width: 50%; height: 30px; border-top: 1px solid red">
                        <a class="button" href="../SaleOrders/SingleGood.aspx?ImageAddress=<%#Eval("ImgAddress") %>">立即购买</a>
                    </div>
                </div>
            </ItemTemplate>
        </asp:DataList>
