<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GA_UpdateHomepage.aspx.cs" Inherits="HitachiStore.backstage.GoodAdmin.GA_UpdateHomepage" %>
        ...
        <asp:UpdatePanel runat="server" ID="updatepal" UpdateMode="Conditional">
            <ContentTemplate>
                <div id="div_top" style="height: 20px; text-align: center">
                    <asp:Label ID="lbPrompt" runat="server" Style="color: Red"></asp:Label>
                </div>
