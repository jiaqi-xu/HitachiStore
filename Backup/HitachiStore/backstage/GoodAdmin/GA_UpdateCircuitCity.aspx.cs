...
{
    public partial class GA_UpdateCircuitCity : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                firstClassName.FirstClassDmName = "家用电器";
                ...
                if (gadmin.UpdatePictureShow(Gadmin, 3).Count > 1)
                {
                    drpdownlist.DataSource = gadmin.UpdatePictureShow(Gadmin, 3);
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            GA Gadmin = new GA();
            GAController gadmin = new GAController();
            if (gadmin.UpdateInterface(Gadmin, info, 3))
            {
                lbPrompt.Text = "修改成功";
            }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            if (drpdownlist.SelectedItem.Text != "请选择替换商品" || drpdownlist.SelectedItem.Text != "")
            {
                if (tbxUpdate.Text != "" || tbxUpdate.Text != null)
                {
                    ...
                    GA Gadmin = new GA();
                    GAController gadmin = new GAController();
                    if (gadmin.UpdateProductShow(Gadmin, 3, url, GoodID))
                    {
                        lbPrompt.Text = "修改成功";
                    }
                }
