...
{
    public partial class GA_UpdateHomepage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Furniture = gadmin.HomePage(Gadmin);
                ...
                int lPageCount = 0;
                lPageCount = Convert.ToInt32(gadmin.HomeCount(Gadmin));
                ...
                lbPage.Text = "第1页共 " + lPageCount.ToString() + "页";
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            if (drpdownlist.SelectedItem.Text != "请选择替换商品" || drpdownlist.SelectedItem.Text != "")
            {
                if (tbxUpdate.Text != "" || tbxUpdate.Text != null)
                {
                    ...
                    GA Gadmin = new GA();
                    GAController gadmin = new GAController();
                    if (gadmin.UpdateProductShow(Gadmin, 1, url, GoodID))
                    {
                        lbPrompt.Text = "修改成功";
                    }
                }
