<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OA_FirstLogin.aspx.cs" Inherits="HitachiStore.backstage.OrderAdmin.OA_FirstLogin" MasterPageFile="~/backstage/Back_Master/FirstLogin.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div style="height: 488px; width:147px">
        ...
        <li><a href="OA_AdminInfo.aspx">订单管理员个人信息</a></li>
        ...
        <li><a href="OA_OrderExam.aspx" onfocus ="aa">订单的查看</a></li>
