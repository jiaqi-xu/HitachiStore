<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SA_AdminInfo.aspx.cs" Inherits="HitachiStore.backstage.SeniorAdmin.SA_AdminInfo" %>
...
<body>
    ...
    <div>
      ...
      <div style="height:600px">
           ...
           <%-- 主界面 --%>
            <div align="center" >
            <div style="width:55%; background-color:#add2da; height :350px; margin-top :100px"align="center">
            ...
            <table>
                ...
                <tr align="left"> 
                  ...
                  <td style="height:32px">
                      <asp:TextBox ID="txtStaffID" runat="server" Width="155px"  
                ...
                <tr align="left"> 
                  ...
                  <td style="height:32px">
                      <asp:TextBox ID="txtStaffName" runat="server"  Width="155px" 
                ...
                <tr align="left"> 
                  ...
                  <td style="height:32px">
                      <asp:TextBox ID="txtAdministratorClass" runat="server"  Width="155px" 
                          Enabled="False"></asp:TextBox>
                  </td>
                </tr>
                <%-- 姓名--%>
                <tr align="left"> 
                  ...
                  <td style="height:32px">
                      <asp:TextBox ID="txtName" runat="server"  Width="155px" MaxLength="40" 
                ...
                <tr align="left"> 
                  ...
                  <td style="height:32px">
                      <asp:TextBox ID="txtRegister" runat="server"  Width="155px" 
                          Enabled="False"></asp:TextBox>
                  </td>
                </tr>
                <%--对个人信息的修改--%>
              ...
              <div><asp:Button ID="btnAlter" runat="server" Text="修改" Height="37px" Width="76px" 
